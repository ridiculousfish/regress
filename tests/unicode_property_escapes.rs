...
fn unicode_escape_property_binary_patternsyntax_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 248] = [
        ...
        "\u{2e52}", "\u{2e53}", "\u{3001}", "\u{3008}", "\u{3009}", "\u{300a}", "\u{300b}",
...
fn unicode_escape_property_binary_variationselector_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{180b}", "\u{fe00}", "\u{e0100}"];
...
#[test]
fn unicode_escape_property_script_anatolianhieroglyphs() {
    test_with_configs(unicode_escape_property_script_anatolianhieroglyphs_tc)
}

fn unicode_escape_property_script_anatolianhieroglyphs_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{14400}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_armenian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 9] = [
        "\u{531}", "\u{559}", "\u{55a}", "\u{560}", "\u{589}", "\u{58a}", "\u{58d}", "\u{58f}",
        "\u{fb13}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Armenian}+$",
...
fn unicode_escape_property_script_avestan_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10b00}", "\u{10b39}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Avestan}+$",
        "^\\p{sc=Avestan}+$",
        "^\\p{Script=Avst}+$",
...
fn unicode_escape_property_script_balinese_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 17] = [
        "\u{1b00}", "\u{1b04}", "\u{1b05}", "\u{1b34}", "\u{1b35}", "\u{1b36}", "\u{1b3b}",
        "\u{1b3c}", "\u{1b3d}", "\u{1b42}", "\u{1b43}", "\u{1b45}", "\u{1b50}", "\u{1b5a}",
        "\u{1b61}", "\u{1b6b}", "\u{1b74}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Balinese}+$",
        "^\\p{sc=Balinese}+$",
...
fn unicode_escape_property_script_bamum_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 5] = ["\u{a6a0}", "\u{a6e6}", "\u{a6f0}", "\u{a6f2}", "\u{16800}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Bamum}+$",
        "^\\p{sc=Bamum}+$",
        "^\\p{Script=Bamu}+$",
...
#[test]
fn unicode_escape_property_script_bassavah() {
    test_with_configs(unicode_escape_property_script_bassavah_tc)
}

fn unicode_escape_property_script_bassavah_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{16ad0}", "\u{16af0}", "\u{16af5}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Bassa_Vah}+$",
        "^\\p{sc=Bassa_Vah}+$",
        "^\\p{Script=Bass}+$",
...
fn unicode_escape_property_script_batak_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 10] = [
        "\u{1bc0}", "\u{1be6}", "\u{1be7}", "\u{1be8}", "\u{1bea}", "\u{1bed}", "\u{1bee}",
        "\u{1bef}", "\u{1bf2}", "\u{1bfc}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Batak}+$",
        "^\\p{sc=Batak}+$",
...
fn unicode_escape_property_script_bengali_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 30] = [
        "\u{980}", "\u{981}", "\u{982}", "\u{985}", "\u{98f}", "\u{993}", "\u{9aa}", "\u{9b2}",
        "\u{9b6}", "\u{9bc}", "\u{9bd}", "\u{9be}", "\u{9c1}", "\u{9c7}", "\u{9cb}", "\u{9cd}",
        "\u{9ce}", "\u{9d7}", "\u{9dc}", "\u{9df}", "\u{9e2}", "\u{9e6}", "\u{9f0}", "\u{9f2}",
        "\u{9f4}", "\u{9fa}", "\u{9fb}", "\u{9fc}", "\u{9fd}", "\u{9fe}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Bengali}+$",
        "^\\p{sc=Bengali}+$",
...
fn unicode_escape_property_script_bopomofo_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{2ea}", "\u{3105}", "\u{31a0}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Bopomofo}+$",
        "^\\p{sc=Bopomofo}+$",
        "^\\p{Script=Bopo}+$",
...
fn unicode_escape_property_script_braille_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{2800}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Braille}+$",
        "^\\p{sc=Braille}+$",
        "^\\p{Script=Brai}+$",
...
fn unicode_escape_property_script_buginese_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 5] = ["\u{1a00}", "\u{1a17}", "\u{1a19}", "\u{1a1b}", "\u{1a1e}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Buginese}+$",
        "^\\p{sc=Buginese}+$",
        "^\\p{Script=Bugi}+$",
...
fn unicode_escape_property_script_buhid_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{1740}", "\u{1752}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Buhid}+$",
        "^\\p{sc=Buhid}+$",
        "^\\p{Script=Buhd}+$",
...
#[test]
fn unicode_escape_property_script_canadianaboriginal() {
    test_with_configs(unicode_escape_property_script_canadianaboriginal_tc)
}

fn unicode_escape_property_script_canadianaboriginal_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 6] = [
        "\u{1400}", "\u{1401}", "\u{166d}", "\u{166e}", "\u{166f}", "\u{18b0}",
    ];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_carian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{102a0}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Carian}+$",
        "^\\p{sc=Carian}+$",
        "^\\p{Script=Cari}+$",
...
#[test]
fn unicode_escape_property_script_caucasianalbanian() {
    test_with_configs(unicode_escape_property_script_caucasianalbanian_tc)
}

fn unicode_escape_property_script_caucasianalbanian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10530}", "\u{1056f}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_cham_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 13] = [
        "\u{aa00}", "\u{aa29}", "\u{aa2f}", "\u{aa31}", "\u{aa33}", "\u{aa35}", "\u{aa40}",
        "\u{aa43}", "\u{aa44}", "\u{aa4c}", "\u{aa4d}", "\u{aa50}", "\u{aa5c}",
    ];
...
fn unicode_escape_property_script_chorasmian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10fb0}", "\u{10fc5}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Chorasmian}+$",
        "^\\p{sc=Chorasmian}+$",
        "^\\p{Script=Chrs}+$",
...
fn unicode_escape_property_script_cherokee_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{13a0}", "\u{13f8}", "\u{ab70}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Cherokee}+$",
        "^\\p{sc=Cherokee}+$",
        "^\\p{Script=Cher}+$",
...
fn unicode_escape_property_script_coptic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 9] = [
        "\u{3e2}", "\u{2c80}", "\u{2ce5}", "\u{2ceb}", "\u{2cef}", "\u{2cf2}", "\u{2cf9}",
        "\u{2cfd}", "\u{2cfe}",
    ];
    const REGEXES: [&str; 6] = [
        "^\\p{Script=Coptic}+$",
...
fn unicode_escape_property_script_cuneiform_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{12000}", "\u{12400}", "\u{12470}", "\u{12480}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Cuneiform}+$",
        "^\\p{sc=Cuneiform}+$",
        "^\\p{Script=Xsux}+$",
...
fn unicode_escape_property_script_cyrillic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 22] = [
        "\u{400}", "\u{482}", "\u{483}", "\u{487}", "\u{488}", "\u{48a}", "\u{1c80}", "\u{1d2b}",
        "\u{1d78}", "\u{2de0}", "\u{a640}", "\u{a66e}", "\u{a66f}", "\u{a670}", "\u{a673}",
        "\u{a674}", "\u{a67e}", "\u{a67f}", "\u{a680}", "\u{a69c}", "\u{a69e}", "\u{fe2e}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Cyrillic}+$",
        "^\\p{sc=Cyrillic}+$",
...
fn unicode_escape_property_script_deseret_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10400}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Deseret}+$",
        "^\\p{sc=Deseret}+$",
        "^\\p{Script=Dsrt}+$",
...
fn unicode_escape_property_script_devanagari_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 27] = [
        "\u{900}", "\u{903}", "\u{904}", "\u{93a}", "\u{93b}", "\u{93c}", "\u{93d}", "\u{93e}",
        "\u{941}", "\u{949}", "\u{94d}", "\u{94e}", "\u{950}", "\u{955}", "\u{958}", "\u{962}",
        "\u{966}", "\u{970}", "\u{971}", "\u{972}", "\u{a8e0}", "\u{a8f2}", "\u{a8f8}", "\u{a8fb}",
        "\u{a8fc}", "\u{a8fd}", "\u{a8ff}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Devanagari}+$",
        "^\\p{sc=Devanagari}+$",
...
#[test]
fn unicode_escape_property_script_divesakuru() {
    test_with_configs(unicode_escape_property_script_divesakuru_tc)
}

fn unicode_escape_property_script_divesakuru_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 17] = [
        "\u{11900}",
        "\u{11909}",
        "\u{1190c}",
...
#[test]
fn unicode_escape_property_script_egyptianhieroglyphs() {
    test_with_configs(unicode_escape_property_script_egyptianhieroglyphs_tc)
}

fn unicode_escape_property_script_egyptianhieroglyphs_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{13000}", "\u{13430}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_elbasan_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10500}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Elbasan}+$",
        "^\\p{sc=Elbasan}+$",
        "^\\p{Script=Elba}+$",
...
fn unicode_escape_property_script_elymaic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10fe0}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Elymaic}+$",
        "^\\p{sc=Elymaic}+$",
        "^\\p{Script=Elym}+$",
...
fn unicode_escape_property_script_ethiopic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 35] = [
        "\u{1200}", "\u{124a}", "\u{1250}", "\u{1258}", "\u{125a}", "\u{1260}", "\u{128a}",
        "\u{1290}", "\u{12b2}", "\u{12b8}", "\u{12c0}", "\u{12c2}", "\u{12c8}", "\u{12d8}",
        "\u{1312}", "\u{1318}", "\u{135d}", "\u{1360}", "\u{1369}", "\u{1380}", "\u{1390}",
        "\u{2d80}", "\u{2da0}", "\u{2da8}", "\u{2db0}", "\u{2db8}", "\u{2dc0}", "\u{2dc8}",
        "\u{2dd0}", "\u{2dd8}", "\u{ab01}", "\u{ab09}", "\u{ab11}", "\u{ab20}", "\u{ab28}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Ethiopic}+$",
        "^\\p{sc=Ethiopic}+$",
...
fn unicode_escape_property_script_georgian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 11] = [
        "\u{10a0}", "\u{10c7}", "\u{10cd}", "\u{10d0}", "\u{10fc}", "\u{10fd}", "\u{1c90}",
        "\u{1cbd}", "\u{2d00}", "\u{2d27}", "\u{2d2d}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Georgian}+$",
        "^\\p{sc=Georgian}+$",
...
fn unicode_escape_property_script_gothic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{10330}", "\u{10341}", "\u{10342}", "\u{1034a}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Gothic}+$",
        "^\\p{sc=Gothic}+$",
        "^\\p{Script=Goth}+$",
...
fn unicode_escape_property_script_gujarati_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 24] = [
        "\u{a81}", "\u{a83}", "\u{a85}", "\u{a8f}", "\u{a93}", "\u{aaa}", "\u{ab2}", "\u{ab5}",
        "\u{abc}", "\u{abd}", "\u{abe}", "\u{ac1}", "\u{ac7}", "\u{ac9}", "\u{acb}", "\u{acd}",
        "\u{ad0}", "\u{ae0}", "\u{ae2}", "\u{ae6}", "\u{af0}", "\u{af1}", "\u{af9}", "\u{afa}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Gujarati}+$",
        "^\\p{sc=Gujarati}+$",
...
#[test]
fn unicode_escape_property_script_gunjalagondi() {
    test_with_configs(unicode_escape_property_script_gunjalagondi_tc)
}

fn unicode_escape_property_script_gunjalagondi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 11] = [
        "\u{11d60}",
        "\u{11d67}",
        "\u{11d6a}",
...
fn unicode_escape_property_script_gurmukhi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 22] = [
        "\u{a01}", "\u{a03}", "\u{a05}", "\u{a0f}", "\u{a13}", "\u{a2a}", "\u{a32}", "\u{a35}",
        "\u{a38}", "\u{a3c}", "\u{a3e}", "\u{a41}", "\u{a47}", "\u{a4b}", "\u{a51}", "\u{a59}",
        "\u{a5e}", "\u{a66}", "\u{a70}", "\u{a72}", "\u{a75}", "\u{a76}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Gurmukhi}+$",
        "^\\p{sc=Gurmukhi}+$",
...
fn unicode_escape_property_script_hangul_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 14] = [
        "\u{1100}", "\u{302e}", "\u{3131}", "\u{3200}", "\u{3260}", "\u{a960}", "\u{ac00}",
        "\u{d7b0}", "\u{d7cb}", "\u{ffa0}", "\u{ffc2}", "\u{ffca}", "\u{ffd2}", "\u{ffda}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Hangul}+$",
        "^\\p{sc=Hangul}+$",
...
#[test]
fn unicode_escape_property_script_hanifirohingya() {
    test_with_configs(unicode_escape_property_script_hanifirohingya_tc)
}

fn unicode_escape_property_script_hanifirohingya_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10d00}", "\u{10d24}", "\u{10d30}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_hanunoo_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{1720}", "\u{1732}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Hanunoo}+$",
        "^\\p{sc=Hanunoo}+$",
        "^\\p{Script=Hano}+$",
...
fn unicode_escape_property_script_hatran_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{108e0}", "\u{108f4}", "\u{108fb}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Hatran}+$",
        "^\\p{sc=Hatran}+$",
        "^\\p{Script=Hatr}+$",
...
fn unicode_escape_property_script_hebrew_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 22] = [
        "\u{591}", "\u{5be}", "\u{5bf}", "\u{5c0}", "\u{5c1}", "\u{5c3}", "\u{5c4}", "\u{5c6}",
        "\u{5c7}", "\u{5d0}", "\u{5ef}", "\u{5f3}", "\u{fb1d}", "\u{fb1e}", "\u{fb1f}", "\u{fb29}",
        "\u{fb2a}", "\u{fb38}", "\u{fb3e}", "\u{fb40}", "\u{fb43}", "\u{fb46}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Hebrew}+$",
        "^\\p{sc=Hebrew}+$",
...
#[test]
fn unicode_escape_property_script_imperialaramaic() {
    test_with_configs(unicode_escape_property_script_imperialaramaic_tc)
}

fn unicode_escape_property_script_imperialaramaic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10840}", "\u{10857}", "\u{10858}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_inscriptionalpahlavi() {
    test_with_configs(unicode_escape_property_script_inscriptionalpahlavi_tc)
}

fn unicode_escape_property_script_inscriptionalpahlavi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10b60}", "\u{10b78}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_inscriptionalparthian() {
    test_with_configs(unicode_escape_property_script_inscriptionalparthian_tc)
}

fn unicode_escape_property_script_inscriptionalparthian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10b40}", "\u{10b58}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_javanese_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 12] = [
        "\u{a980}", "\u{a983}", "\u{a984}", "\u{a9b3}", "\u{a9b4}", "\u{a9b6}", "\u{a9ba}",
        "\u{a9bc}", "\u{a9be}", "\u{a9c1}", "\u{a9d0}", "\u{a9de}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Javanese}+$",
        "^\\p{sc=Javanese}+$",
...
fn unicode_escape_property_script_kannada_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 24] = [
        "\u{c80}", "\u{c81}", "\u{c82}", "\u{c84}", "\u{c85}", "\u{c8e}", "\u{c92}", "\u{caa}",
        "\u{cb5}", "\u{cbc}", "\u{cbd}", "\u{cbe}", "\u{cbf}", "\u{cc0}", "\u{cc6}", "\u{cc7}",
        "\u{cca}", "\u{ccc}", "\u{cd5}", "\u{cde}", "\u{ce0}", "\u{ce2}", "\u{ce6}", "\u{cf1}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Kannada}+$",
        "^\\p{sc=Kannada}+$",
...
#[test]
fn unicode_escape_property_script_kayahli() {
    test_with_configs(unicode_escape_property_script_kayahli_tc)
}

fn unicode_escape_property_script_kayahli_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{a900}", "\u{a90a}", "\u{a926}", "\u{a92f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Kayah_Li}+$",
        "^\\p{sc=Kayah_Li}+$",
        "^\\p{Script=Kali}+$",
...
#[test]
fn unicode_escape_property_script_khitansmallscript() {
    test_with_configs(unicode_escape_property_script_khitansmallscript_tc)
}

fn unicode_escape_property_script_khitansmallscript_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{16fe4}", "\u{18b00}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_khmer_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 17] = [
        "\u{1780}", "\u{17b4}", "\u{17b6}", "\u{17b7}", "\u{17be}", "\u{17c6}", "\u{17c7}",
        "\u{17c9}", "\u{17d4}", "\u{17d7}", "\u{17d8}", "\u{17db}", "\u{17dc}", "\u{17dd}",
        "\u{17e0}", "\u{17f0}", "\u{19e0}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Khmer}+$",
        "^\\p{sc=Khmer}+$",
...
fn unicode_escape_property_script_lao_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 15] = [
        "\u{e81}", "\u{e84}", "\u{e86}", "\u{e8c}", "\u{ea5}", "\u{ea7}", "\u{eb1}", "\u{eb2}",
        "\u{eb4}", "\u{ebd}", "\u{ec0}", "\u{ec6}", "\u{ec8}", "\u{ed0}", "\u{edc}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Lao}+$",
        "^\\p{sc=Lao}+$",
...
fn unicode_escape_property_script_latin_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 54] = [
        "\u{41}", "\u{61}", "\u{aa}", "\u{ba}", "\u{c0}", "\u{d8}", "\u{f8}", "\u{1bb}", "\u{1bc}",
        "\u{1c0}", "\u{1c4}", "\u{294}", "\u{295}", "\u{2b0}", "\u{2e0}", "\u{1d00}", "\u{1d2c}",
        "\u{1d62}", "\u{1d6b}", "\u{1d79}", "\u{1d9b}", "\u{1e00}", "\u{2071}", "\u{207f}",
        "\u{2090}", "\u{212a}", "\u{2132}", "\u{214e}", "\u{2160}", "\u{2183}", "\u{2185}",
        "\u{2c60}", "\u{2c7c}", "\u{2c7e}", "\u{a722}", "\u{a770}", "\u{a771}", "\u{a78b}",
        "\u{a78f}", "\u{a790}", "\u{a7c2}", "\u{a7f5}", "\u{a7f7}", "\u{a7f8}", "\u{a7fa}",
        "\u{a7fb}", "\u{ab30}", "\u{ab5c}", "\u{ab60}", "\u{ab66}", "\u{ab69}", "\u{fb00}",
        "\u{ff21}", "\u{ff41}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Latin}+$",
...
fn unicode_escape_property_script_lepcha_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 8] = [
        "\u{1c00}", "\u{1c24}", "\u{1c2c}", "\u{1c34}", "\u{1c36}", "\u{1c3b}", "\u{1c40}",
        "\u{1c4d}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Lepcha}+$",
...
fn unicode_escape_property_script_limbu_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 12] = [
        "\u{1900}", "\u{1920}", "\u{1923}", "\u{1927}", "\u{1929}", "\u{1930}", "\u{1932}",
        "\u{1933}", "\u{1939}", "\u{1940}", "\u{1944}", "\u{1946}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Limbu}+$",
        "^\\p{sc=Limbu}+$",
...
#[test]
fn unicode_escape_property_script_lineara() {
    test_with_configs(unicode_escape_property_script_lineara_tc)
}

fn unicode_escape_property_script_lineara_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10600}", "\u{10740}", "\u{10760}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Linear_A}+$",
        "^\\p{sc=Linear_A}+$",
        "^\\p{Script=Lina}+$",
...
#[test]
fn unicode_escape_property_script_linearb() {
    test_with_configs(unicode_escape_property_script_linearb_tc)
}

fn unicode_escape_property_script_linearb_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 7] = [
        "\u{10000}",
        "\u{1000d}",
        "\u{10028}",
...
fn unicode_escape_property_script_lisu_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{a4d0}", "\u{a4f8}", "\u{a4fe}", "\u{11fb0}"];
...
fn unicode_escape_property_script_lycian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10280}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Lycian}+$",
        "^\\p{sc=Lycian}+$",
        "^\\p{Script=Lyci}+$",
...
fn unicode_escape_property_script_lydian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10920}", "\u{1093f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Lydian}+$",
        "^\\p{sc=Lydian}+$",
        "^\\p{Script=Lydi}+$",
...
fn unicode_escape_property_script_mahajani_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{11150}", "\u{11173}", "\u{11174}", "\u{11176}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Mahajani}+$",
        "^\\p{sc=Mahajani}+$",
        "^\\p{Script=Mahj}+$",
...
fn unicode_escape_property_script_makasar_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{11ee0}", "\u{11ef3}", "\u{11ef5}", "\u{11ef7}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Makasar}+$",
        "^\\p{sc=Makasar}+$",
        "^\\p{Script=Maka}+$",
...
fn unicode_escape_property_script_malayalam_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 23] = [
        "\u{d00}", "\u{d02}", "\u{d04}", "\u{d0e}", "\u{d12}", "\u{d3b}", "\u{d3d}", "\u{d3e}",
        "\u{d41}", "\u{d46}", "\u{d4a}", "\u{d4d}", "\u{d4e}", "\u{d4f}", "\u{d54}", "\u{d57}",
        "\u{d58}", "\u{d5f}", "\u{d62}", "\u{d66}", "\u{d70}", "\u{d79}", "\u{d7a}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Malayalam}+$",
        "^\\p{sc=Malayalam}+$",
...
fn unicode_escape_property_script_mandaic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{840}", "\u{859}", "\u{85e}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Mandaic}+$",
        "^\\p{sc=Mandaic}+$",
        "^\\p{Script=Mand}+$",
...
fn unicode_escape_property_script_medefaidrin_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{16e40}", "\u{16e80}", "\u{16e97}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_masaramgondi() {
    test_with_configs(unicode_escape_property_script_masaramgondi_tc)
}

fn unicode_escape_property_script_masaramgondi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 10] = [
        "\u{11d00}",
        "\u{11d08}",
        "\u{11d0b}",
...
#[test]
fn unicode_escape_property_script_meeteimayek() {
    test_with_configs(unicode_escape_property_script_meeteimayek_tc)
}

fn unicode_escape_property_script_meeteimayek_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 19] = [
        "\u{aae0}", "\u{aaeb}", "\u{aaec}", "\u{aaee}", "\u{aaf0}", "\u{aaf2}", "\u{aaf3}",
        "\u{aaf5}", "\u{aaf6}", "\u{abc0}", "\u{abe3}", "\u{abe5}", "\u{abe6}", "\u{abe8}",
        "\u{abe9}", "\u{abeb}", "\u{abec}", "\u{abed}", "\u{abf0}",
    ];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_mendekikakui() {
    test_with_configs(unicode_escape_property_script_mendekikakui_tc)
}

fn unicode_escape_property_script_mendekikakui_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{1e800}", "\u{1e8c7}", "\u{1e8d0}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_meroiticcursive() {
    test_with_configs(unicode_escape_property_script_meroiticcursive_tc)
}

fn unicode_escape_property_script_meroiticcursive_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 5] = [
        "\u{109a0}",
        "\u{109bc}",
        "\u{109be}",
...
#[test]
fn unicode_escape_property_script_meroitichieroglyphs() {
    test_with_configs(unicode_escape_property_script_meroitichieroglyphs_tc)
}

fn unicode_escape_property_script_meroitichieroglyphs_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10980}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_mro_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{16a40}", "\u{16a60}", "\u{16a6e}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Mro}+$",
        "^\\p{sc=Mro}+$",
        "^\\p{Script=Mroo}+$",
...
fn unicode_escape_property_script_myanmar_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 50] = [
        "\u{1000}", "\u{102b}", "\u{102d}", "\u{1031}", "\u{1032}", "\u{1038}", "\u{1039}",
        "\u{103b}", "\u{103d}", "\u{103f}", "\u{1040}", "\u{104a}", "\u{1050}", "\u{1056}",
        "\u{1058}", "\u{105a}", "\u{105e}", "\u{1061}", "\u{1062}", "\u{1065}", "\u{1067}",
        "\u{106e}", "\u{1071}", "\u{1075}", "\u{1082}", "\u{1083}", "\u{1085}", "\u{1087}",
        "\u{108d}", "\u{108e}", "\u{108f}", "\u{1090}", "\u{109a}", "\u{109d}", "\u{109e}",
        "\u{a9e0}", "\u{a9e5}", "\u{a9e6}", "\u{a9e7}", "\u{a9f0}", "\u{a9fa}", "\u{aa60}",
        "\u{aa70}", "\u{aa71}", "\u{aa77}", "\u{aa7a}", "\u{aa7b}", "\u{aa7c}", "\u{aa7d}",
        "\u{aa7e}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Myanmar}+$",
...
fn unicode_escape_property_script_nabataean_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10880}", "\u{108a7}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Nabataean}+$",
        "^\\p{sc=Nabataean}+$",
        "^\\p{Script=Nbat}+$",
...
#[test]
fn unicode_escape_property_script_newtailue() {
    test_with_configs(unicode_escape_property_script_newtailue_tc)
}

fn unicode_escape_property_script_newtailue_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 5] = ["\u{1980}", "\u{19b0}", "\u{19d0}", "\u{19da}", "\u{19de}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_nko_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 9] = [
        "\u{7c0}", "\u{7ca}", "\u{7eb}", "\u{7f4}", "\u{7f6}", "\u{7f7}", "\u{7fa}", "\u{7fd}",
        "\u{7fe}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Nko}+$",
...
fn unicode_escape_property_script_nushu_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{16fe1}", "\u{1b170}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Nushu}+$",
        "^\\p{sc=Nushu}+$",
        "^\\p{Script=Nshu}+$",
...
#[test]
fn unicode_escape_property_script_nyiakengpuachuehmong() {
    test_with_configs(unicode_escape_property_script_nyiakengpuachuehmong_tc)
}

fn unicode_escape_property_script_nyiakengpuachuehmong_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 6] = [
        "\u{1e100}",
        "\u{1e130}",
        "\u{1e137}",
...
fn unicode_escape_property_script_ogham_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{1680}", "\u{1681}", "\u{169b}", "\u{169c}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Ogham}+$",
        "^\\p{sc=Ogham}+$",
        "^\\p{Script=Ogam}+$",
...
#[test]
fn unicode_escape_property_script_olchiki() {
    test_with_configs(unicode_escape_property_script_olchiki_tc)
}

fn unicode_escape_property_script_olchiki_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{1c50}", "\u{1c5a}", "\u{1c78}", "\u{1c7e}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Ol_Chiki}+$",
        "^\\p{sc=Ol_Chiki}+$",
        "^\\p{Script=Olck}+$",
...
#[test]
fn unicode_escape_property_script_oldhungarian() {
    test_with_configs(unicode_escape_property_script_oldhungarian_tc)
}

fn unicode_escape_property_script_oldhungarian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10c80}", "\u{10cc0}", "\u{10cfa}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_olditalic() {
    test_with_configs(unicode_escape_property_script_olditalic_tc)
}

fn unicode_escape_property_script_olditalic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10300}", "\u{10320}", "\u{1032d}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Old_Italic}+$",
        "^\\p{sc=Old_Italic}+$",
        "^\\p{Script=Ital}+$",
...
#[test]
fn unicode_escape_property_script_oldnortharabian() {
    test_with_configs(unicode_escape_property_script_oldnortharabian_tc)
}

fn unicode_escape_property_script_oldnortharabian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10a80}", "\u{10a9d}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_oldpermic() {
    test_with_configs(unicode_escape_property_script_oldpermic_tc)
}

fn unicode_escape_property_script_oldpermic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10350}", "\u{10376}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Old_Permic}+$",
        "^\\p{sc=Old_Permic}+$",
        "^\\p{Script=Perm}+$",
...
#[test]
fn unicode_escape_property_script_oldpersian() {
    test_with_configs(unicode_escape_property_script_oldpersian_tc)
}

fn unicode_escape_property_script_oldpersian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{103a0}", "\u{103c8}", "\u{103d0}", "\u{103d1}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_oldsogdian() {
    test_with_configs(unicode_escape_property_script_oldsogdian_tc)
}

fn unicode_escape_property_script_oldsogdian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10f00}", "\u{10f1d}", "\u{10f27}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_oldsoutharabian() {
    test_with_configs(unicode_escape_property_script_oldsoutharabian_tc)
}

fn unicode_escape_property_script_oldsoutharabian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10a60}", "\u{10a7d}", "\u{10a7f}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_oldturkic() {
    test_with_configs(unicode_escape_property_script_oldturkic_tc)
}

fn unicode_escape_property_script_oldturkic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10c00}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Old_Turkic}+$",
        "^\\p{sc=Old_Turkic}+$",
        "^\\p{Script=Orkh}+$",
...
fn unicode_escape_property_script_oriya_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 26] = [
        "\u{b01}", "\u{b02}", "\u{b05}", "\u{b0f}", "\u{b13}", "\u{b2a}", "\u{b32}", "\u{b35}",
        "\u{b3c}", "\u{b3d}", "\u{b3e}", "\u{b3f}", "\u{b40}", "\u{b41}", "\u{b47}", "\u{b4b}",
        "\u{b4d}", "\u{b55}", "\u{b57}", "\u{b5c}", "\u{b5f}", "\u{b62}", "\u{b66}", "\u{b70}",
        "\u{b71}", "\u{b72}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Oriya}+$",
...
fn unicode_escape_property_script_osage_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{104b0}", "\u{104d8}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Osage}+$",
        "^\\p{sc=Osage}+$",
        "^\\p{Script=Osge}+$",
...
fn unicode_escape_property_script_osmanya_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10480}", "\u{104a0}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Osmanya}+$",
        "^\\p{sc=Osmanya}+$",
        "^\\p{Script=Osma}+$",
...
#[test]
fn unicode_escape_property_script_pahawhhmong() {
    test_with_configs(unicode_escape_property_script_pahawhhmong_tc)
}

fn unicode_escape_property_script_pahawhhmong_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 11] = [
        "\u{16b00}",
        "\u{16b30}",
        "\u{16b37}",
...
fn unicode_escape_property_script_palmyrene_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10860}", "\u{10877}", "\u{10879}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Palmyrene}+$",
        "^\\p{sc=Palmyrene}+$",
        "^\\p{Script=Palm}+$",
...
#[test]
fn unicode_escape_property_script_paucinhau() {
    test_with_configs(unicode_escape_property_script_paucinhau_tc)
}

fn unicode_escape_property_script_paucinhau_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{11ac0}"];
    const REGEXES: [&str; 4] = [
...
#[test]
fn unicode_escape_property_script_phagspa() {
    test_with_configs(unicode_escape_property_script_phagspa_tc)
}

fn unicode_escape_property_script_phagspa_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{a840}", "\u{a874}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Phags_Pa}+$",
        "^\\p{sc=Phags_Pa}+$",
        "^\\p{Script=Phag}+$",
...
fn unicode_escape_property_script_phoenician_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10900}", "\u{10916}", "\u{1091f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Phoenician}+$",
        "^\\p{sc=Phoenician}+$",
        "^\\p{Script=Phnx}+$",
...
#[test]
fn unicode_escape_property_script_psalterpahlavi() {
    test_with_configs(unicode_escape_property_script_psalterpahlavi_tc)
}

fn unicode_escape_property_script_psalterpahlavi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{10b80}", "\u{10b99}", "\u{10ba9}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_rejang_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{a930}", "\u{a947}", "\u{a952}", "\u{a95f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Rejang}+$",
        "^\\p{sc=Rejang}+$",
        "^\\p{Script=Rjng}+$",
...
fn unicode_escape_property_script_runic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{16a0}", "\u{16ee}", "\u{16f1}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Runic}+$",
        "^\\p{sc=Runic}+$",
        "^\\p{Script=Runr}+$",
...
fn unicode_escape_property_script_samaritan_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 9] = [
        "\u{800}", "\u{816}", "\u{81a}", "\u{81b}", "\u{824}", "\u{825}", "\u{828}", "\u{829}",
        "\u{830}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Samaritan}+$",
...
fn unicode_escape_property_script_saurashtra_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 6] = [
        "\u{a880}", "\u{a882}", "\u{a8b4}", "\u{a8c4}", "\u{a8ce}", "\u{a8d0}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Saurashtra}+$",
        "^\\p{sc=Saurashtra}+$",
...
fn unicode_escape_property_script_shavian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 1] = ["\u{10450}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Shavian}+$",
        "^\\p{sc=Shavian}+$",
        "^\\p{Script=Shaw}+$",
...
fn unicode_escape_property_script_sogdian_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{10f30}", "\u{10f46}", "\u{10f51}", "\u{10f55}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Sogdian}+$",
        "^\\p{sc=Sogdian}+$",
        "^\\p{Script=Sogd}+$",
...
#[test]
fn unicode_escape_property_script_sorasompeng() {
    test_with_configs(unicode_escape_property_script_sorasompeng_tc)
}

fn unicode_escape_property_script_sorasompeng_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{110d0}", "\u{110f0}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_sundanese_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 13] = [
        "\u{1b80}", "\u{1b82}", "\u{1b83}", "\u{1ba1}", "\u{1ba2}", "\u{1ba6}", "\u{1ba8}",
        "\u{1baa}", "\u{1bab}", "\u{1bae}", "\u{1bb0}", "\u{1bba}", "\u{1cc0}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Sundanese}+$",
        "^\\p{sc=Sundanese}+$",
...
#[test]
fn unicode_escape_property_script_sylotinagri() {
    test_with_configs(unicode_escape_property_script_sylotinagri_tc)
}

fn unicode_escape_property_script_sylotinagri_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 12] = [
        "\u{a800}", "\u{a802}", "\u{a803}", "\u{a806}", "\u{a807}", "\u{a80b}", "\u{a80c}",
        "\u{a823}", "\u{a825}", "\u{a827}", "\u{a828}", "\u{a82c}",
    ];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_syriac_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 8] = [
        "\u{700}", "\u{70f}", "\u{710}", "\u{711}", "\u{712}", "\u{730}", "\u{74d}", "\u{860}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Syriac}+$",
        "^\\p{sc=Syriac}+$",
...
fn unicode_escape_property_script_tagalog_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{1700}", "\u{170e}", "\u{1712}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tagalog}+$",
        "^\\p{sc=Tagalog}+$",
        "^\\p{Script=Tglg}+$",
...
fn unicode_escape_property_script_tagbanwa_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{1760}", "\u{176e}", "\u{1772}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tagbanwa}+$",
        "^\\p{sc=Tagbanwa}+$",
        "^\\p{Script=Tagb}+$",
...
#[test]
fn unicode_escape_property_script_taile() {
    test_with_configs(unicode_escape_property_script_taile_tc)
}

fn unicode_escape_property_script_taile_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{1950}", "\u{1970}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tai_Le}+$",
        "^\\p{sc=Tai_Le}+$",
        "^\\p{Script=Tale}+$",
...
#[test]
fn unicode_escape_property_script_taitham() {
    test_with_configs(unicode_escape_property_script_taitham_tc)
}

fn unicode_escape_property_script_taitham_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 18] = [
        "\u{1a20}", "\u{1a55}", "\u{1a56}", "\u{1a57}", "\u{1a58}", "\u{1a60}", "\u{1a61}",
        "\u{1a62}", "\u{1a63}", "\u{1a65}", "\u{1a6d}", "\u{1a73}", "\u{1a7f}", "\u{1a80}",
        "\u{1a90}", "\u{1aa0}", "\u{1aa7}", "\u{1aa8}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tai_Tham}+$",
        "^\\p{sc=Tai_Tham}+$",
...
#[test]
fn unicode_escape_property_script_taiviet() {
    test_with_configs(unicode_escape_property_script_taiviet_tc)
}

fn unicode_escape_property_script_taiviet_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 14] = [
        "\u{aa80}", "\u{aab0}", "\u{aab1}", "\u{aab2}", "\u{aab5}", "\u{aab7}", "\u{aab9}",
        "\u{aabe}", "\u{aac0}", "\u{aac1}", "\u{aac2}", "\u{aadb}", "\u{aadd}", "\u{aade}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tai_Viet}+$",
        "^\\p{sc=Tai_Viet}+$",
...
fn unicode_escape_property_script_tangut_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{16fe0}", "\u{17000}", "\u{18800}", "\u{18d00}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tangut}+$",
        "^\\p{sc=Tangut}+$",
        "^\\p{Script=Tang}+$",
...
fn unicode_escape_property_script_telugu_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 20] = [
        "\u{c00}", "\u{c01}", "\u{c04}", "\u{c05}", "\u{c0e}", "\u{c12}", "\u{c2a}", "\u{c3d}",
        "\u{c3e}", "\u{c41}", "\u{c46}", "\u{c4a}", "\u{c55}", "\u{c58}", "\u{c60}", "\u{c62}",
        "\u{c66}", "\u{c77}", "\u{c78}", "\u{c7f}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Telugu}+$",
        "^\\p{sc=Telugu}+$",
...
fn unicode_escape_property_script_thaana_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{780}", "\u{7a6}", "\u{7b1}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Thaana}+$",
        "^\\p{sc=Thaana}+$",
        "^\\p{Script=Thaa}+$",
...
fn unicode_escape_property_script_thai_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 10] = [
        "\u{e01}", "\u{e31}", "\u{e32}", "\u{e34}", "\u{e40}", "\u{e46}", "\u{e47}", "\u{e4f}",
        "\u{e50}", "\u{e5a}",
    ];
...
fn unicode_escape_property_script_tibetan_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 37] = [
        "\u{f00}", "\u{f01}", "\u{f04}", "\u{f13}", "\u{f14}", "\u{f15}", "\u{f18}", "\u{f1a}",
        "\u{f20}", "\u{f2a}", "\u{f34}", "\u{f35}", "\u{f36}", "\u{f37}", "\u{f38}", "\u{f39}",
        "\u{f3a}", "\u{f3b}", "\u{f3c}", "\u{f3d}", "\u{f3e}", "\u{f40}", "\u{f49}", "\u{f71}",
        "\u{f7f}", "\u{f80}", "\u{f85}", "\u{f86}", "\u{f88}", "\u{f8d}", "\u{f99}", "\u{fbe}",
        "\u{fc6}", "\u{fc7}", "\u{fce}", "\u{fd0}", "\u{fd9}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tibetan}+$",
        "^\\p{sc=Tibetan}+$",
...
fn unicode_escape_property_script_tifinagh_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{2d30}", "\u{2d6f}", "\u{2d70}", "\u{2d7f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tifinagh}+$",
        "^\\p{sc=Tifinagh}+$",
        "^\\p{Script=Tfng}+$",
...
fn unicode_escape_property_script_ugaritic_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 2] = ["\u{10380}", "\u{1039f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Ugaritic}+$",
        "^\\p{sc=Ugaritic}+$",
        "^\\p{Script=Ugar}+$",
...
fn unicode_escape_property_script_vai_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 6] = [
        "\u{a500}", "\u{a60c}", "\u{a60d}", "\u{a610}", "\u{a620}", "\u{a62a}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Vai}+$",
        "^\\p{sc=Vai}+$",
...
fn unicode_escape_property_script_wancho_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{1e2c0}", "\u{1e2ec}", "\u{1e2f0}", "\u{1e2ff}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Wancho}+$",
        "^\\p{sc=Wancho}+$",
        "^\\p{Script=Wcho}+$",
...
#[test]
fn unicode_escape_property_script_warangciti() {
    test_with_configs(unicode_escape_property_script_warangciti_tc)
}

fn unicode_escape_property_script_warangciti_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{118a0}", "\u{118e0}", "\u{118ea}", "\u{118ff}"];
    const REGEXES: [&str; 4] = [
...
fn unicode_escape_property_script_yezidi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{10e80}", "\u{10eab}", "\u{10ead}", "\u{10eb0}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Yezidi}+$",
        "^\\p{sc=Yezidi}+$",
        "^\\p{Script=Yezi}+$",
...
fn unicode_escape_property_script_yi_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{a000}", "\u{a015}", "\u{a016}", "\u{a490}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Yi}+$",
        "^\\p{sc=Yi}+$",
        "^\\p{Script=Yiii}+$",
...
#[test]
fn unicode_escape_property_script_zanabazarsquare() {
    test_with_configs(unicode_escape_property_script_zanabazarsquare_tc)
}

fn unicode_escape_property_script_zanabazarsquare_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 9] = [
        "\u{11a00}",
        "\u{11a01}",
        "\u{11a0b}",
...
fn unicode_escape_property_gc_closepunctuation_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 72] = [
        ...
        "\u{3019}", "\u{301b}", "\u{301e}", "\u{fd3e}", "\u{fe18}", "\u{fe36}", "\u{fe38}",
        "\u{fe3a}", "\u{fe3c}", "\u{fe3e}", "\u{fe40}", "\u{fe42}", "\u{fe44}", "\u{fe48}",
        "\u{fe5a}", "\u{fe5c}", "\u{fe5e}", "\u{ff09}", "\u{ff3d}", "\u{ff5d}", "\u{ff60}",
        "\u{ff63}",
    ];
    const REGEXES: [&str; 6] = [
...
fn unicode_escape_property_gc_openpunctuation_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 75] = [
        ...
        "\u{2e26}", "\u{2e28}", "\u{2e42}", "\u{3008}", "\u{300a}", "\u{300c}", "\u{300e}",
        "\u{3010}", "\u{3014}", "\u{3016}", "\u{3018}", "\u{301a}", "\u{301d}", "\u{fd3f}",
        "\u{fe17}", "\u{fe35}", "\u{fe37}", "\u{fe39}", "\u{fe3b}", "\u{fe3d}", "\u{fe3f}",
        "\u{fe41}", "\u{fe43}", "\u{fe47}", "\u{fe59}", "\u{fe5b}", "\u{fe5d}", "\u{ff08}",
