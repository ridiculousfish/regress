...
fn unicode_escape_property_script_hanunoo_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 3] = ["\u{1720}", "\u{1732}", "\u{1734}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Hanunoo}+$",
        "^\\p{sc=Hanunoo}+$",
        "^\\p{Script=Hano}+$",
...
fn unicode_escape_property_script_tagalog_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 4] = ["\u{1700}", "\u{1712}", "\u{1715}", "\u{171f}"];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Tagalog}+$",
        "^\\p{sc=Tagalog}+$",
        "^\\p{Script=Tglg}+$",
...
fn unicode_escape_property_script_telugu_tc(tc: TestConfig) {
    const CODE_POINTS: [&str; 22] = [
        "\u{c00}", "\u{c01}", "\u{c04}", "\u{c05}", "\u{c0e}", "\u{c12}", "\u{c2a}", "\u{c3c}",
        "\u{c3d}", "\u{c3e}", "\u{c41}", "\u{c46}", "\u{c4a}", "\u{c55}", "\u{c58}", "\u{c5d}",
        "\u{c60}", "\u{c62}", "\u{c66}", "\u{c77}", "\u{c78}", "\u{c7f}",
    ];
    const REGEXES: [&str; 4] = [
        "^\\p{Script=Telugu}+$",
        "^\\p{sc=Telugu}+$",
